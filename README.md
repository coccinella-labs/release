<p align="center">
  <img src="https://raw.githubusercontent.com/Coccinella-Labs/release/main/.github/assets/thumbnail.png" alt="release" width="100%">
</p>
...
jobs:
  release:
    ...
    steps:
      - uses: coccinella-labs/release@v1.1.1
        with:
